...
return new class extends Migration
{
    ...
    {
        Schema::create('wheel_chair_orders', function (Blueprint $table) {
            $table->id();
            $table->foreignId('service_id')->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('wheel_chair_id')->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            $table->string('jumlah');
    ...
    {
        Schema::dropIfExists('wheel_chair_orders');
    }
};
